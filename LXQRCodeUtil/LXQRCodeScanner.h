...
/// 若使用 IB，可通过 outlet 设置该属性；若使用代码，可通过该属性获取一个 `LXCaptureVideoPreviewView` 对象。
...
- (void)startRunningWithCompletion:(void (^)(BOOL success, NSError *_Nullable error))completion;
